...
<table class="table table-striped table-hover">
        ...
        try {
        	...
        	ResultSet resultSet=statement
					.executeQuery("SELECT item.itemId,item.itemname,item.category,item.price,orders.quantity FROM orders JOIN  item on item.itemId=orders.itemId and orders.username='"+session.getAttribute("user")+"' and orders.orderId="+request.getParameter("usertansferid")+";");
